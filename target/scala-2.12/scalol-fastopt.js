...
$c_Ltutorial_webapp_Main$.prototype.parse__sjs_js_Dynamic__T__Ltutorial_webapp_HtmlObject = (function(obj, typeOfObject) {
  ...
  } else if ((typeOfObject === "user")) {
    return new $c_Ltutorial_webapp_User().init___()
...
$c_Ltutorial_webapp_PostView$.prototype.start__V = (function() {
  ...
  if (($as_T($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().localStorage.getItem("scalol_token")) !== null)) {
    ...
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#comment").append("<div class=\"alert alert-info\">\n  <strong>You cannot comment!</strong> Login or Sign up to comment.\n</div>")
  }
});
...
$c_Ltutorial_webapp_UserView.prototype.$$js$exported$meth$start__O = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hey\n")
});
...
$c_Ltutorial_webapp_User.prototype.init___ = (function() {
  return this
});
...
/** @constructor */
$e.UserView = (function() {
  var $thiz = new $c_Ltutorial_webapp_UserView();
  $c_Ltutorial_webapp_UserView.prototype.init___.call($thiz);
  return $thiz
});
$e.UserView.prototype = $c_Ltutorial_webapp_UserView.prototype;
